...
/*test how to create a variable with the following categories:
	1-hh has only 18-30 year olds in it
	2-hh has only 30-65 year olds in it
	3-hh has only 65+ in it
	4-hh has 0-18 and 18-30 in it
	5-hh has 0-18 and 30-65 in it
	6-hh has 0-18 and 65+ in it
	7-hh has 18-30 and 65+ in it
	8-hh has 30-65 and 65+ in it
	9-hh has 18-30 and 65+ in it
	10-hh has 0-18, 18-30 and 30-65 in it
	11-hh has 0-18, 18-30 and 65+ in it
	12-hh has 0-18, 30-65 and 65+ in it
	13-hh has 18-30, 30-65 and 65+ in it
	14-hh has 0-18, 18-30, 30-65 and 65+ in it
*/
*first of all, create age bands that I need for this
egen ageCatHHRisk=cut(age), at (0, 18, 30, 65, 200)
recode ageCatHHRisk 0=1 18=2 30=3 65=4 
label define ageCatHHRiskLabel 1 "0-17" 2 "18-29" 3 "30-64" 4 "65+"
label values ageCatHHRisk ageCatHHRiskLabel
tab ageCatHHRisk, miss
...
preserve
	...
	*mark whether hh has each age category using egen max which returns true (1) or false (0) (see https://www.stata.com/support/faqs/data-management/create-variable-recording/)
	...
	egen has30_65=max(ageCatHHRisk==3), by(hh_id)
	egen has65Plus=max(ageCatHHRisk==4), by(hh_id)
	...
	*Key:
	/*test how to create a variable with the following categories:
		...
		7-hh has 18-30 and 65+ in it
		8-hh has 30-65 and 65+ in it
		9-hh has 18-30 and 30-65 in it
		10-hh has 0-18, 18-30 and 30-65 in it
		11-hh has 0-18, 18-30 and 65+ in it
		12-hh has 0-18, 30-65 and 65+ in it
		13-hh has 18-30, 30-65 and 65+ in it
		14-hh has 0-18, 18-30, 30-65 and 65+ in it
	*/
	replace hhRiskCat=1 if has18_29==1 & hasUnder18==0 & has30_65==0 & has65Plus==0
	replace hhRiskCat=2 if has18_29==0 & hasUnder18==0 & has30_65==1 & has65Plus==0
	replace hhRiskCat=3 if has18_29==0 & hasUnder18==0 & has30_65==0 & has65Plus==1
	replace hhRiskCat=4 if has18_29==1 & hasUnder18==1 & has30_65==0 & has65Plus==0
	replace hhRiskCat=5 if has18_29==0 & hasUnder18==1 & has30_65==1 & has65Plus==0
	replace hhRiskCat=6 if has18_29==0 & hasUnder18==1 & has30_65==0 & has65Plus==1
	replace hhRiskCat=7 if has18_29==1 & hasUnder18==0 & has30_65==0 & has65Plus==1
	replace hhRiskCat=8 if has18_29==0 & hasUnder18==0 & has30_65==1 & has65Plus==1
	replace hhRiskCat=9 if has18_29==1 & hasUnder18==0 & has30_65==1 & has65Plus==0
	replace hhRiskCat=10 if has18_29==1 & hasUnder18==1 & has30_65==1 & has65Plus==0
	replace hhRiskCat=11 if has18_29==1 & hasUnder18==1 & has30_65==0 & has65Plus==1
	replace hhRiskCat=12 if has18_29==0 & hasUnder18==1 & has30_65==1 & has65Plus==1
	replace hhRiskCat=13 if has18_29==1 & hasUnder18==0 & has30_65==1 & has65Plus==1
	replace hhRiskCat=14 if has18_29==1 & hasUnder18==1 & has30_65==1 & has65Plus==1
	
	*label variable
	label define hhRiskCatLabel 1 "Only 18-29" 2 "Only 30-64" 3 "Only 65+" 4 "0-17 with 18-29" 5 "0-17 with 30-64" 6 "0-17 with 65+" 7 "18-29 with 65+" 8 "30-65 with 65+" 9 "18-29 with 30-64" 10 "0-17, 18-29 and 30-64" 11 "0-17, 18-29 and 65+" 12 "0-17, 30-64 and 65+" 13 "18-29, 30-64 and 65+" 14 "0-18, 18-30, 30-65 and 65+"
...
*save a reduced version of this variable for describing only multigenerational households with higher risk (based on age) adults in them i.e. over the age of 65
generate hhRiskCat_Ov65=.
la var hhRiskCat_Ov65 "Age group(s) of hh occupants (only for hh with at least 1 >65)"
replace hhRiskCat_Ov65=1 if hhRiskCat==3
replace hhRiskCat_Ov65=2 if hhRiskCat==6
replace hhRiskCat_Ov65=3 if hhRiskCat==7
replace hhRiskCat_Ov65=4 if hhRiskCat==8
replace hhRiskCat_Ov65=5 if hhRiskCat==11
replace hhRiskCat_Ov65=6 if hhRiskCat==12
replace hhRiskCat_Ov65=7 if hhRiskCat==13
replace hhRiskCat_Ov65=8 if hhRiskCat==14
label define hhRiskCat_Ov65Label 1 "Only 65+" 2 "0-17 with 65+" 3 "18-29 with 65+" 4 "30-65 with 65+" 5 "0-17, 18-29 and 65+" 6 "0-17, 30-64 and 65+" 7 "18-29, 30-64 and 65+" 8 "0-18, 18-30, 30-65 and 65+"
label values hhRiskCat_Ov65 hhRiskCat_Ov65Label
tab hhRiskCat_Ov65, miss
tab hhRiskCat_Ov65
