...
capture log close
log using ./logs/03_hhClassif_an_descriptive_table_1`fileextension', replace t
...
file open tablecontent using ./output/table1_hhClassif`fileextension'.txt, write text replace
...
clear
insheet using ./output/table1_hhClassif`fileextension'.txt, clear


export excel using ./output/table1_hhClassif`fileextension'.xlsx, replace
