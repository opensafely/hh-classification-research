...
foreach outcome in covidDeath {
	...
	* Open a log file
	capture log close
	log using "./logs/20b_hhClassif_an_mv_analysis_CombinedwInteractions_67SEPARATED_HR_table_`outcome'_`dataset'", text replace
	...
	*open table
	file open tablecontents using ./output/20b_hhClassif_an_mv_analysis_CombinedwInteractions_67SEPARATED_HR_table_`outcome'_`dataset'.txt, t w replace
