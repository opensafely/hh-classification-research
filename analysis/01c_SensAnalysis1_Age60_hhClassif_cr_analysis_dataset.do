...
* Open a log file
cap log close
log using ./logs/01c_SensAnalysis1_Age60_hhClassif_cr_analysis_dataset`fileextension'.log, replace t
...
restore
*/
*this is the file that I need to the descriptive analysis of hh_id versus hh_size on (restricting to people over the age of 60)
...
*for next bit need to find all those houses where all people were over the age of 60

generate ov60YrOld=0
replace ov60YrOld=1 if age >60 & age!=.
la var ov60YrOld "Flags whether person is over the age of 60"
generate allOv60=0
la var allOv60 "Flags whether everyone in the house is over 60"
sort hh_id ov60YrOld
by hh_id: replace allOv60=1 if ov60YrOld[1]==1

di "***********************FLOWCHART 6d. Living in a private home greater than 4 in size where all occupants are over the age of 60********************:"
safecount if allOv60==1 & hh_size>4
drop if allOv60==1 & hh_size>4
...
/*test how to create a variable with the following categories (see protocol safetable 1)
	...
	3 SG3 - hh has only 60+ in it
	4 2G1 - hh has 0-17 and 18-29 in it
	5 2G2 - hh has 0-17 and 30-66 in it
	6 2G3 - hh has 0-17 and 60+ in it
	7 2G4 - hh has 18-29 and 60+ in it
	8 2G5 - hh has 30-66 and 60+ in it
	9 2G6 - hh has 18-29 and 60+ in it
	10 MG1 - hh has 0-17, 18-29 and 30-66 in it
	11 MG2 - hh has 0-17, 18-29 and 60+ in it
	12 MG3 - hh has 0-17, 30-66 and 60+ in it
	13 MG4 - hh has 18-29, 30-66 and 60+ in it
	14 MG5 - hh has 0-17, 18-29, 30-66 and 60+ in it
*/
*first of all, create age bands that I need for this
egen ageCatHHRisk=cut(age), at (0, 18, 30, 60, 200)
recode ageCatHHRisk 0=0 18=1 30=2 60=3 
label define ageCatHHRisk 0 "0-17" 1 "18-29" 2 "30-66" 3 "60+"
label values ageCatHHRisk ageCatHHRisk
safetab ageCatHHRisk, miss
la var ageCatHHRisk "Age categorised for HH risk analysis"

*make an age category variable here that is for table 1 of the 60+ year old analysis
egen ageCatfor60Plus=cut(age), at (60, 70, 75, 80, 85, 200)
recode ageCatfor60Plus 60=0 70=1 75=2 80=3 85=4 
label define ageCatfor60Plus 0 "60-69" 1 "70-74" 2 "75-79" 3 "80-84" 4 "85+"
label values ageCatfor60Plus ageCatfor60Plus
safetab ageCatfor60Plus, miss
la var ageCatfor60Plus "Age (categories)"
*check groupins
forvalues i=0/4{
	sum age if ageCatfor60Plus==`i'
}
...
preserve
	...
	*mark whether hh has each age category using egen max which returns true (1) or false (0) (see https://www.stata.com/support/faqs/data-management/create-variable-recording/)
	...
	egen has30_59=max(ageCatHHRisk==2), by(hh_id)
	egen has60Plus=max(ageCatHHRisk==3), by(hh_id)
	...
	*Key:
	/*test how to create a variable with the following categories:
			1 SG1 - hh has only 18-29 year olds in it
			2 SG2 - hh has only 30-59 year olds in it
			3 SG3 - hh has only 60+ in it
			4 2G1 - hh has 0-17 and 18-29 in it
			5 2G2 - hh has 0-17 and 30-59 in it
			6 2G3 - hh has 0-17 and 60+ in it
			7 2G4 - hh has 18-29 and 60+ in it
			8 2G5 - hh has 30-66 and 60+ in it
			9 2G6 - hh has 18-29 and 60+ in it
			10 MG1 - hh has 0-17, 18-29 and 30-59 in it
			11 MG2 - hh has 0-17, 18-29 and 60+ in it
			12 MG3 - hh has 0-17, 30-59 and 60+ in it
			13 MG4 - hh has 18-29, 30-59 and 60+ in it
			14 MG5 - hh has 0-17, 18-29, 30-59 and 60+ in it
	*/
	replace hhRiskCat=0 if hasUnder18==1 & has18_29==0 & has30_59==0 & has60Plus==0
	replace hhRiskCat=1 if hasUnder18==0 & has18_29==1 & has30_59==0 & has60Plus==0
	replace hhRiskCat=2 if hasUnder18==0 & has18_29==0 & has30_59==1 & has60Plus==0
	replace hhRiskCat=3 if hasUnder18==0 & has18_29==0 & has30_59==0 & has60Plus==1
	replace hhRiskCat=4 if hasUnder18==1 & has18_29==1 & has30_59==0 & has60Plus==0
	replace hhRiskCat=5 if hasUnder18==1 & has18_29==0 & has30_59==1 & has60Plus==0
	replace hhRiskCat=6 if hasUnder18==1 & has18_29==0 & has30_59==0 & has60Plus==1
	replace hhRiskCat=7 if hasUnder18==0 & has18_29==1 & has30_59==1 & has60Plus==0
	replace hhRiskCat=8 if hasUnder18==0 & has18_29==1 & has30_59==0 & has60Plus==1
	replace hhRiskCat=9 if hasUnder18==0 & has18_29==0 & has30_59==1 & has60Plus==1
	replace hhRiskCat=10 if hasUnder18==1 & has18_29==1 & has30_59==1 & has60Plus==0
	replace hhRiskCat=11 if hasUnder18==1 & has18_29==1 & has30_59==0 & has60Plus==1
	replace hhRiskCat=12 if hasUnder18==1 & has18_29==0 & has30_59==1 & has60Plus==1
	replace hhRiskCat=13 if hasUnder18==0 & has18_29==1 & has30_59==1 & has60Plus==1
	replace hhRiskCat=14 if hasUnder18==1 & has18_29==1 & has30_59==1 & has60Plus==1
	
	*label variable
	label define hhRiskCatLabel 0 "Only <18"  1 "Only 18-29" 2 "Only 30-59" 3 "Only 60+" 4 "0-17 & 18-29" 5 "0-17 & 30-59" 6 "0-17 & 60+" 7 "18-29 & 30-59" 8 "18-29 & 60+" 9 "30-59 & 60+" 10 "0-17, 18-29 & 30-59" 11 "0-17, 18-29 & 60+" 12 "0-17, 30-59 & 60+" 13 "18-29, 30-59 & 60+" 14 "0-17, 18-29, 30-59 & 60+"
...
*(b) variable for stratifying by the oldest age group (60+)
generate hhRiskCat60PLUS=.
la var hhRiskCat60PLUS "hhRiskCat for the over 60 year old age group"
replace hhRiskCat60PLUS=1 if hhRiskCat==3
replace hhRiskCat60PLUS=2 if hhRiskCat==6
replace hhRiskCat60PLUS=3 if hhRiskCat==8
replace hhRiskCat60PLUS=4 if hhRiskCat==9
replace hhRiskCat60PLUS=5 if hhRiskCat==11
replace hhRiskCat60PLUS=6 if hhRiskCat==12
replace hhRiskCat60PLUS=7 if hhRiskCat==13
replace hhRiskCat60PLUS=8 if hhRiskCat==14
*label variable
label define hhRiskCat60PLUS 1 "Only 60+" 2 "0-17 & 60+" 3 "18-29 & 60+" 4 "30-59 & 60+" 5 "0-17, 18-29 & 60+" 6 "0-17, 30-59 & 60+" 7 "18-29, 30-59 & 60+" 8 "0-17, 18-29, 30-59 & 60+"
label values hhRiskCat60PLUS hhRiskCat60PLUS
safetab hhRiskCat hhRiskCat60PLUS, miss
...
generate hhRiskCat60PLUS_3cats=.
la var hhRiskCat60PLUS_3cats "hhRiskCat for the over 60 year old age group - 3 categories"
replace hhRiskCat60PLUS_3cats=1 if hhRiskCat60PLUS==1
replace hhRiskCat60PLUS_3cats=2 if hhRiskCat60PLUS>1 & hhRiskCat60PLUS<5
replace hhRiskCat60PLUS_3cats=3 if hhRiskCat60PLUS>4
*label variable
label define hhRiskCat60PLUS_3cats 1 "Only 60+" 2 "60+ & 1 other gen" 3 "60+ & >1 other gen"
label values hhRiskCat60PLUS_3cats hhRiskCat60PLUS_3cats
safetab hhRiskCat60PLUS hhRiskCat60PLUS_3cats, miss
...
generate hhRiskCat60PLUS_4cats=.
la var hhRiskCat60PLUS_4cats "hhRiskCat for the over 60 year old age group - 4 categories"
replace hhRiskCat60PLUS_4cats=1 if hhRiskCat60PLUS==1
replace hhRiskCat60PLUS_4cats=2 if hhRiskCat60PLUS>1 & hhRiskCat60PLUS<5
replace hhRiskCat60PLUS_4cats=3 if hhRiskCat60PLUS>4 & hhRiskCat60PLUS<8
replace hhRiskCat60PLUS_4cats=4 if hhRiskCat60PLUS==8
*label variable
label define hhRiskCat60PLUS_4cats 1 "Only 60+" 2 "60+ & 1 other gen" 3 "60+ & 2 other gens" 4 "60+ & 3 other gens"
label values hhRiskCat60PLUS_4cats hhRiskCat60PLUS_4cats
safetab hhRiskCat60PLUS hhRiskCat60PLUS_4cats, miss
...
replace hh_size=4 if hhRiskCat60PLUS_4cats==1 & hh_size>4
replace hh_total_cat=2 if hhRiskCat60PLUS_4cats==1 & hh_total_cat>2
...
*label variable
label define hhRiskCat33TO66 1 "Only 30-66" 2 "0-17 & 30-66" 3 "18-29 & 30-66" 4 "30-66 & 60+" 5 "0-17, 18-29 & 30-66" 6 "0-17, 30-66 & 60+" 7 "18-29, 30-66 & 60+" 8 "0-17, 18-29, 30-66 & 60+"
...
*label variable
label define hhRiskCat18TO29 1 "Only 18-29" 2 "0-17 & 18-29" 3 "18-29 & 30-66" 4 "18-29 & 60+" 5 "0-17, 18-29 & 30-66" 6 "0-17, 18-29 & 60+" 7 "18-29, 30-66 & 60+" 8 "0-17, 18-29, 30-66 & 60+"
...
di "***********************FLOWCHART 6. ADULTS AGED LESS THAN 60********************:"
safecount if age<60
drop if age<60


di "***********************FLOWCHART 7. ADULTS AGED 60 OR OVER********************:"
safecount
...
save ./output/SensAnalysis1_Age60_dataset`dataset'.dta, replace
...
*Age category 3: 60+
use ./output/SensAnalysis1_Age60_dataset`dataset'.dta, clear
tab ageCatHHRisk
tab ageCatHHRisk, nolabel
tab hhRiskCat
tab hhRiskCat60PLUS
...
tab hhRiskCat
rename hhRiskCat60PLUS hhRiskCatExp
rename hhRiskCat60PLUS_3cats hhRiskCatExp_3cats
rename hhRiskCat60PLUS_4cats hhRiskCatExp_4cats
