...
*household size with 5 categories
gen hh_total_5cats=.
replace hh_total_5cats=2 if hh_size ==1
...
label values hh_total_5cats hh_total_5cats
la var hh_total_5cats "(TPP) hh_size variable in four categories"

safetab hh_total_5cats
...
keep hhRiskCat67PLUS_5cats stime_nonCOVIDDeathCase nonCOVIDDeathCase nonCOVIDDeathCaseDate  patient_id eth5 eth16 enter_date imd smoke obese4cat rural_urbanFive ageCatfor67Plus male coMorbCat utla_group hh_id hh_total_cat hh_total_4cats hh_total_5cats HHRiskCatCOMPandSIZEBROAD hh_size
...
* overall
use ./output/hhClassif_analysis_dataset_ageband_3`dataset', clear
keep hhRiskCat67PLUS_5cats stime_covidHospCase covidHospCase covidHospCaseDate patient_id eth5 eth16 enter_date imd smoke obese4cat rural_urbanFive ageCatfor67Plus male coMorbCat utla_group hh_id hh_total_cat hh_total_4cats hh_total_5cats HHRiskCatCOMPandSIZEBROAD hh_size
...
*overall
use ./output/hhClassif_analysis_dataset_ageband_3`dataset', clear
keep hhRiskCat67PLUS_5cats stime_covidDeathCase covidDeathCase covidDeathCaseDate patient_id eth5 eth16 enter_date imd smoke obese4cat rural_urbanFive ageCatfor67Plus male coMorbCat utla_group hh_id hh_total_cat hh_total_4cats hh_total_5cats HHRiskCatCOMPandSIZEBROAD hh_size
...
*overall
use ./output/hhClassif_analysis_dataset_ageband_3`dataset', clear
keep hhRiskCat67PLUS_5cats stime_covidHospOrDeathCase covidHospOrDeathCase covidHospOrDeathCaseDate patient_id eth5 eth16 enter_date imd smoke obese4cat rural_urbanFive ageCatfor67Plus male coMorbCat utla_group hh_id hh_total_cat hh_total_4cats hh_total_5cats HHRiskCatCOMPandSIZEBROAD hh_size
